...
const PathologistPatientProfile = () => {
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Pathology Reports & History</p>
                    </div>
                </div>
            </div>
...
export default PathologistPatientProfile;
